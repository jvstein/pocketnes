...
const fptr multifnlist[]=
{
	...
	ui5,
	#endif
	autoBset,autoAset,controller,ui3,ui2,ui4,
	#if MULTIBOOT
	multiboot,
	#endif
	sleep,restart,exit_
...
const fptr* fnlistX[]=
{
	fnlist1,multifnlist,fnlist2,fnlist3,fnlist4
	#if CHEATFINDER
	,fnlist5
	#endif
};
const fptr drawuiX[]=
{
	drawui1,drawui1,drawui2,drawui3,drawui4
	#if CHEATFINDER
	,drawui5
	#endif
};
...
#endif
#if BRANCHHACKDETAIL
char *const branchtxt[]={"None","BPL","BMI","BVC","BVS","BCC","BCS","BNE","BEQ","JMP"};
#endif
...
void drawui1()
{
	int row=0;
	cls(1);
	strmerge(str,EMUNAME " " VERSION_NUMBER " on ",hostname[gbaversion]);
	drawtext(19,str,0);
...
void drawui2()
{
	...
	#endif
	print_2("Region: ",cntrtxt[(emuflags & 4)>>2]);		//USCOUNTRY=4
}
...
void drawui3()
{
	...
	print_2("Scaling: ",flicktxt[flicker]);
...
void go_multiboot()
{
	...
	textstart=dest;	
	selectedrom=0;
	loadcart(selectedrom,emuflags&0x300);
